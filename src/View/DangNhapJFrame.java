...
public class DangNhapJFrame extends javax.swing.JFrame {
   ...
   NhanVienDAO nhanVienDAO = new NhanVienDAO();
    ...
    public DangNhapJFrame() throws SQLException {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!username.isEmpty() && !password.isEmpty()) {
           ...
           if(check != 0) {
               ...
               MainApp.showTrangChu();
           } else {
               JOptionPane.showMessageDialog(this, "Sai tên đăng nhập hoặc mật khẩu, vui lòng thử lại!");
           }
        } else {
            JOptionPane.showMessageDialog(this, "Hãy nhập đủ các trường dữ liệu!", "Thông báo", JOptionPane.ERROR_MESSAGE);
        }
