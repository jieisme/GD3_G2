...
values ('kietvt', 123, N'Vũ Tuấn Kiệt', 0, '0862132564', 0),
	   ...
	   ('user', 123, N'User Test', 1, '0000000000', 0)
go
-- Quản lý: 0
-- Nhân viên: 1
...
values ('', '', '', 0),
	   (N'Bùi Thị Thanh', '0862132564', N'Hưng Yên', 0),
	   (N'Trần Khắc Long', '0987654321', N'Hà Nội', 0),
	   (N'Long Đẹp Trai', '0989999999', N'Hà Nội', 0),
	   (N'Độ Mixi', '0123456789', N'Cao Bằng', 0)
go
